...
?>
<input type="button" name="Products" value="Products" onclick="document.location.href='admin_product.php'"><br><br>
<input type="button" name="Orders" value="Orders" onclick="document.location.href='admin_orders.php'"><br><br>
